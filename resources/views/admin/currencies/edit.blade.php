...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="position-relative form-group">
            ...
            !!}
            {!! Form::text('money_format_thousands', old('money_format_thousands'), ['class' => 'form-control form-control-sm',
            'placeholder' => '']) !!}
        ...
        <div class="position-relative form-group">
            ...
            ['class' => 'control-label']) !!}
            {!! Form::text('money_format_decimal', old('money_format_decimal'), ['class' => 'form-control form-control-sm',
            'placeholder' => '']) !!}
